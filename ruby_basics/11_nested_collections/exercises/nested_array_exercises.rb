def blank_seating_chart(number_of_rows, seats_per_row)
  # return a 2d array to represent a seating chart that contains number_of_rows nested arrays, each with seats_per_row entries of nil to represent that each seat is empty.
...
def count_empty_seats(chart)
  ...
  chart.each do |c|
    if c == ""
      number_empty_seat.push(c)
    end 
  end
  # NOTE: `chart` should **not** be mutated
 return number_empty_seat.length()
end
...
def find_favorite(array_of_hash_objects)
  ...
  if array_of_hash_objects.length() > 0
...
# puts "1 - blank_seating_chart"
# blank_seating_chart(2,2)
# puts "2 - add_seat_to_row"
# add_seat_to_row([ [22, 2, 2], [ 2, 3, 4] ] , 0 , 10)
# puts "3 - delete_row_from_chart"
# add_another_row([ [22, 2, 2], [ 2, 3, 4] ], [ 0, 0])
# delete_seat_from_row([ [22, 1, 2], [ 3, 4, 5] ] , 0 , 2 )
# puts "4 - delete_row_from_chart"
# delete_row_from_chart([ [0, 1, 2], [ 3, 4, 5] ],0)
# puts "5 - count_empty_seats"
# count_empty_seats([ [0, "", 2], [ 3, 4, ""] ])
find_favorite([
